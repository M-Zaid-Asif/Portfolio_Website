...
const Modal = () => {
  ...
  return (
    <>
      ...
      {isVisible && (
        <div className="flex border border-gray-700 flex-col p-5 mx-auto mt-5 mb-3 [width:70%] rounded-3xl shadow-md shadow-blue-100">
          ...
          <div>
            ...
            <p>
              ...
              walking work of art. Vintage. Beyond valuation, beyond forgery or
              imitation. 18 years since that trembling teenager of touch and
              tease first tiptoed onto this storied stage. Now in his immaculate
