...
const WordCounter = () => {
  ...
  return (
    <>
      <h2 className="text-xl mx-6 font-semibold xl:text-center mt-3">Word Counter</h2>
      <div className="textarea border rounded-2xl border-black shadow-md shadow-blue-100 flex flex-col w-[95%] sm:w-3/4 lg:w-1/2 m-auto p-3 mt-5 b">
